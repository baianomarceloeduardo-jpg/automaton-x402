...
## Current base
```
https://wake-sender-balloon-identified.trycloudflare.com
```
This URL is served by a quick tunnel and **will rotate**. Do not hardcode it.

## Durable resolution (use this)
1. `GET https://wake-sender-balloon-identified.trycloudflare.com/v1/resolve-base` — free, returns the current base.
...
_Generated 2026-09-26T09:01:42.647Z (baseSource=anchor_latest_record)._
